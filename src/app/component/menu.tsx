...
export default function Menu() {
  ...
  return (
    <Section className="w-fit flex md:hidden  overflow-scroll   " >
     ...
     <div className={` top-0 left-0 w-full fixed  z-20 h-full overflow-y-auto bg-transparent  ${open?'translate-x-0 transition-all duration-300':'-translate-x-[320px] transition-all duration-300'}`}>
